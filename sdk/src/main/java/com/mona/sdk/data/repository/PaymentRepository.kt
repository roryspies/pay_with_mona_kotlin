...
internal class PaymentRepository private constructor(
    context: Context,
) {
...
//                }
    ...
    fun buildUrl(
        ...
        val encodedSessionId = URLEncoder.encode(sessionId, utf8)
        val encodedTransactionId = URLEncoder.encode(transactionId, utf8)
        val encodedMethod = URLEncoder.encode(method?.type?.key.orEmpty(), utf8)
    ...
    companion object : SingletonCompanionWithDependency<PaymentRepository, Context>() {
